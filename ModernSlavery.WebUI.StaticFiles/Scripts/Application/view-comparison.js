(function($) {
    ...
    function ViewComparisonViewModel() {
        this.update = function(num) {
            ...
            if (!isNaN(numItems) && !isNaN(num)) {
                ...
                if (numItems === 0 && compBasket.hasClass("show-empty")) {
                    ...
                    compBasketLabel.html("Your comparison list contains <strong>" +
                        numItems +
                        " schools or colleges</strong>");
                }
        ...
        this.updateLegacy = function(num) {
            ...
            if (inCompare && currentTabCount === 0 && num > 0
            ) { // last estab on tab removed> switch to 1st tab with estabs
