        ...
        this.start = function($element) {
            ...
            function addShowHideToggle() {
                $stepHeaders.each(function() {
                    ...
                    if (!$(this).find(".js-toggle-link").length) {
                        $(this).find(".js-step-title-button")
                            .append('<span class="app-step-nav__toggle-link js-toggle-link" aria-hidden="true">' +
                                linkText +
                                "</span>");
                    }
                });
            ...
            function ensureOnlyOneActiveLink() {
                ...
                if (lastClicked) {
                    ...
                    var activeLinkInActiveStep =
                        $element.find(".app-step-nav__step--active").find("." + activeLinkClass).first();
            ...
            function escapeSelector(s) {
                var cssMatcher =
                    /([\x00-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g; // eslint-disable-line no-control-regex
