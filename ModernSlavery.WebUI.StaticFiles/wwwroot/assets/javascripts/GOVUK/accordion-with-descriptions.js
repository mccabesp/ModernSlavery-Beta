    ...
    Modules.AccordionWithDescriptions = function() {
        ...
        this.start = function($element) {
            ...
            function addOpenCloseAllButton() {
                $element.prepend(
                    '<div class="subsection-controls js-subsection-controls"><button aria-expanded="false">Open all</button></div>');
            }
            ...
            function addButtonsToSubsections() {
                ...
                $subsectionTitle.each(function(index) {
                    $(this).wrapInner(
                        '<button class="subsection__button js-subsection-button" aria-expanded="false" aria-controls="subsection_content_' +
                        index +
                        '"></button>');
                });
            }
            ...
            function closeAllSections() {
                $.each($element.find(".js-subsection"),
                    function() {
            ...
            function removeSessionStorage() {
                ...
                if (isClosedSubsections) {
                    ...
                    $closedSubsections.each(function(index) {
                        ...
                        sessionStorage.removeItem(GOVUKServiceManualTopic + subsectionClosedContentId,
                            subsectionClosedContentId);
                    });
                }
            }

            function bindToggleForSubsections() {
                $element.find(".subsection__header").on("click",
                    function(event) {
