...
namespace ModernSlavery.WebUI.Shared.Classes.HttpResultModels
{
    ...
    public class HttpStatusCodeResult : ContentResult
    {
        ...
        public HttpStatusCodeResult(int statusCode, string statusDescription = null, LogLevel? logLevel = null) :
            this(logLevel)
        {
        ...
        //   statusDescription:
        //     The status description.
        public HttpStatusCodeResult(HttpStatusCode statusCode, string statusDescription = null,
        ...
        {
            return new HttpException(StatusCode.Value, Content);
        }
    }
}