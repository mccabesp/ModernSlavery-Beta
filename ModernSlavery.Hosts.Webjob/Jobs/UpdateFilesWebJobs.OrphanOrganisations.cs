        ...
        private async Task<List<UnregisteredOrganisationsFileModel>> GetOrphanOrganisationsAsync()
        {
            ...
            return unregisteredOrgs.Select(
                    org => {
                        ...
                        var expires = _reportingDeadlineHelper.GetReportingDeadline(org.SectorType).ToString("d MMMM yyyy");
                        ...
                        return new UnregisteredOrganisationsFileModel {
                            ...
                            Address1 = addressLines.Count < 1 ? null : addressLines[0],
                            Address2 = addressLines.Count < 2 ? null : addressLines[1],
                            Address3 = addressLines.Count < 3 ? null : addressLines[2],
