...
namespace ModernSlavery.Infrastructure.WebjobHost
{
    public static class Extensions
    {
        public static IHostBuilder ConfigureWebjobHostBuilder<TStartup>(this IHostBuilder hostBuilder, string contentRoot = null, string webRoot = null) where TStartup :IStartup
        {
