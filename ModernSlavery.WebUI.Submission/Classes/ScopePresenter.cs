    ...
    public class ScopePresenter : IScopePresenter
    {
        ...
        public virtual async Task SaveScopesAsync(ScopingViewModel model, IEnumerable<int> snapshotYears)
        {
            ...
            Organisation org = model.OrganisationId == 0
                ? null
                : await _sharedBusinessLogic.DataRepository.FirstOrDefaultAsync<Organisation>(o => o.OrganisationId == model.OrganisationId);
            if (org == null)
            {
        ...
        public virtual async Task SavePresumedScopeAsync(ScopingViewModel model, int snapshotYear)
        {
            ...
            DateTime currentSnapshotDate = _sharedBusinessLogic.GetAccountingStartDate(org.SectorType);
        ...
        {
            Organisation org = await _sharedBusinessLogic.DataRepository.FirstOrDefaultAsync<Organisation>(o => o.EmployerReference == employerReference);
            return org;
        }
