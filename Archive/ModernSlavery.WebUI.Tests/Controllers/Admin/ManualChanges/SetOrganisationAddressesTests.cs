...
namespace ModernSlavery.WebUI.Tests.Controllers.Admin.ManualChanges
{
    ...
    public class SetOrganisationAddressesTests
    {
        ...
        private IList<Core.Entities.Organisation> testOrgData;
        private User testUser;

        private void GenerateTestData()
        {
            testOrgData = new List<Core.Entities.Organisation>(
                new[] {
