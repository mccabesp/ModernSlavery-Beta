...
namespace ModernSlavery.WebUI.Tests.Controllers.Admin
{
    ...
    public class AdminControllerManualChangesHighLevelInfoTests
    {
        ...
        {
            // Arrange
            Core.Entities.Organisation organisationToChangeName = OrganisationHelper.GetPrivateOrganisation("EmployerReference02");
        ...
        {
            Core.Entities.Organisation orgWhoseCompanyNumberWillBeSet = OrganisationHelper.GetPrivateOrganisation("EmployerReference018");
        ...
        {
            // Arrange
            Core.Entities.Organisation organisationToChangeName = OrganisationHelper.GetPrivateOrganisation("EmployerReference01");
