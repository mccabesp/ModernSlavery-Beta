...
namespace ModernSlavery.WebUI.Tests.Controllers.Viewing
{
    [TestFixture]
    [SetCulture("en-GB")]
    public class ViewingControllerTests
    {
        ...
        public void ViewingController_EmployerDeprecated_When_An_Encrypted_Long_Id_Is_Received_Then_()
        {
            ...
            var org = new Core.Entities.Organisation {OrganisationId = 202, Status = OrganisationStatuses.Active};
        ...
        public async Task ViewingController_EmployerDetails_RedirectUsingReturnIdAsync()
        {
            ...
            var org = new Core.Entities.Organisation {OrganisationId = 98745, Status = OrganisationStatuses.Active, OrganisationName = "patata"};
            ...
            string expectedDescriptionMessage)
        {
            ...
            var org = new Core.Entities.Organisation {OrganisationId = 202, Status = orgStatus};
        ...
        {
            // Arrange
            var org = new Core.Entities.Organisation {OrganisationId = 6548, Status = OrganisationStatuses.Active};
        ...
        {
            var org = new Core.Entities.Organisation {OrganisationId = organisationId, Status = organisationStatus};
        ...
        {
            // Arrange
            var org = new Core.Entities.Organisation {OrganisationId = 89754, Status = OrganisationStatuses.Active};
        ...
        {
            // Arrange
            var org = new Core.Entities.Organisation {OrganisationId = 98754, Status = OrganisationStatuses.Active, SectorType = SectorTypes.Public};
        ...
        public void ViewingController_Report_When_GetSubmissionByOrganisationAndYear_Throws_Exception_Then_Returns_CustomError()
        {
            ...
            mockedSubmissionBusinessLogicToSetup
                .Setup(x => x.GetSubmissionByOrganisationAndYear(It.IsAny<Core.Entities.Organisation>(), It.IsAny<int>()))
                .Throws(new Exception("Kaboom"));
