...
namespace ModernSlavery.WebUI.Tests.Controllers.Admin
{
    ...
    public class AdminControllerManualChangesScopeModificationTests
    {
        ...
        public async Task AdminController_ManualChanges_POST_Set_Organisation_As_In_Scope_Succeeds_When_Running_In_Live_Mode()
        {
            ...
            Core.Entities.Organisation organisationOutOfScopeFor2017 =
            ...
            mockedSearchBusinessLogic.Setup(r => r.UpdateSearchIndexAsync(It.IsAny<Core.Entities.Organisation>()))
            ...
            var modifiedOrg = _dbObjects.FirstOrDefault(x => x.GetType() == typeof(Core.Entities.Organisation)) as Core.Entities.Organisation;
        ...
        private static AdminController AdminController(out ManualChangesViewModel manualChangesViewModel,
            IEnumerable<Core.Entities.Organisation> listOfOrganisations = null)
        {
        ...
        {
            // Arrange
            Core.Entities.Organisation activeOrganisation =
            ...
            Core.Entities.Organisation[] listOfOrganisations = {activeOrganisation};
        ...
        {
            // Arrange
            Core.Entities.Organisation retiredOrganisationThatWasActive =
                OrganisationHelper.GetConcreteOrganisation(
            ...
            Core.Entities.Organisation retiredOrganisationThatWasPending =
                OrganisationHelper.GetConcreteOrganisation(
            ...
            Core.Entities.Organisation[] listOfOrganisations = {retiredOrganisationThatWasActive, activeOrganisation, retiredOrganisationThatWasPending};
            AdminController adminController = AdminController(out ManualChangesViewModel manualChangesViewModel, listOfOrganisations);
        ...
        public async Task AdminController_ManualChanges_POST_UnRetire_Organisations_Exceptions_Are_Caught_And_Reported()
        {
            ...
            var mockOrg = new Mock<Core.Entities.Organisation>();
            ...
            Core.Entities.Organisation org = mockOrg.Object;
            ...
            AdminController_ManualChanges_POST_Set_Organisation_As_Out_Of_Scope_Selects_Current_Year_When_Snapshot_Date_Is_Missing()
        {
            ...
            Core.Entities.Organisation organisationInScopeForCurrentYear =
            ...
            string expectedResult)
        {
            ...
            Core.Entities.Organisation organisationInScopeForCurrentYear = OrganisationHelper.GetOrganisationInScope(TestEmployerReference, snapshotYear);
            _dbObjects = new object[] {organisationInScopeForCurrentYear, _databaseAdminUser}.AsQueryable();
