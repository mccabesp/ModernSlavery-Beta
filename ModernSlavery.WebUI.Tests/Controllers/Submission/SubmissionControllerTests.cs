...
namespace ModernSlavery.WebUI.Tests.Controllers.Submission
{
    ...
    public partial class SubmitControllerTests
    {
            ...
            SubmitController_CheckData_GET_ShouldProvideLateReason_Returns_False_When_Public_Org_Reports_On_Time_And_No_Records_In_Db()
        {
            ...
            var organisation = new Core.Entities.Organisation {OrganisationId = 1254, SectorType = SectorTypes.Public};
            ...
            SubmitController_CheckData_GET_ShouldProvideLateReason_Returns_True_When_Private_Org_Reports_Late_And_No_Records_In_Db()
        {
            ...
            var organisation = new Core.Entities.Organisation {OrganisationId = 6812, SectorType = SectorTypes.Private};
        ...
        public async Task SubmitController_CheckData_GET_Success()
        {
            ...
            var organisation = new Core.Entities.Organisation {OrganisationId = new Random().Next(1000, 9999), SectorType = SectorTypes.Private};
            var userOrganisation = new UserOrganisation {
                OrganisationId = organisation.OrganisationId,
        ...
        public async Task SubmitController_CheckData_GET_When_Old_Submission_NoError()
        {
            ...
            Core.Entities.Organisation mockedOrganisation = OrganisationHelper.GetPublicOrganisation();
        ...
        public async Task SubmitController_CheckData_GET_When_Return_ViewModel_Not_Stashed_SessionExpired()
        {
            ...
            var organisation = new Core.Entities.Organisation {OrganisationId = 1, SectorType = SectorTypes.Private};
            var userOrganisation = new UserOrganisation {
                OrganisationId = organisation.OrganisationId,
                Organisation = organisation,
                UserId = 1,
        ...
        public async Task SubmitController_CheckData_POST_Success()
        {
            ...
            var organisation = new Core.Entities.Organisation {OrganisationId = testOrganisationId, SectorType = SectorTypes.Private};
            var userOrganisation = new UserOrganisation {
                OrganisationId = organisation.OrganisationId,
                Organisation = organisation,
                UserId = testUserId,
            ...
            Return resultDB = controller.SharedBusinessLogic.DataRepository.GetAll<Return>().FirstOrDefault(r => r.ReturnId == testReturnId);
        ...
        public async Task SubmitController_CheckData_POST_Success_When_Sector_Is_Public_Then_Exclude_Person_Responsible_Section()
        {
            ...
            var organisation = new Core.Entities.Organisation {OrganisationId = testOrganisationId, SectorType = SectorTypes.Public};
            var userOrganisation = new UserOrganisation {
                OrganisationId = organisation.OrganisationId,
                Organisation = organisation,
                UserId = testUserId,
        ...
        public async Task SubmitController_CheckData_POST_When_CompanyLinkToGPGInfo_Is_Bigger_Than_250_Char_Model_Is_Invalid()
        {
            ...
            mockedDatabase.Setup(x => x.Get<Core.Entities.Organisation>(It.IsAny<long>())).Returns(mockedOrganisation);
        ...
        public async Task SubmitController_CheckData_POST_When_Should_not_Change_Modified_Date_Then_Sets_ModifiedDate()
        {
            ...
            ConfigHelpers.SharedOptions.EnableSubmitAlerts = true;
        ...
        {
            // Arrange:
            Core.Entities.Organisation testOrganisation = OrganisationHelper.GetPublicOrganisation();
        ...
        public async Task SubmitController_EnterCalculations_GET_Wen_User_Has_No_Return_Then_A_New_Public_Sector_Return_Should_Be_Created()
        {
            ...
            UserOrganisation mockedUserOrganisation = UserOrganisationHelper.LinkUserWithOrganisation(mockedUser, mockedOrganisation);
            Return mockedReturn = ReturnHelper.GetNewReturnForOrganisationAndYear(mockedUserOrganisation, ConfigHelpers.SharedOptions.FirstReportingYear);
        ...
        {
            User mockedUser = UserHelper.GetNotAdminUserWithVerifiedEmailAddress();
            Core.Entities.Organisation mockedOrganisation = OrganisationHelper.GetPrivateOrganisation();
            mockedOrganisation.OrganisationId = new Random().Next(1000, 9999);
            UserOrganisation mockedUserOrganisation = UserOrganisationHelper.LinkUserWithOrganisation(mockedUser, mockedOrganisation);
            Return mockedReturn = ReturnHelper.GetNewReturnForOrganisationAndYear(mockedUserOrganisation, ConfigHelpers.SharedOptions.FirstReportingYear);
        ...
        public async Task SubmitController_EnterCalculations_POST_EmptyFields_ShowAllErrors()
        {
            ...
            ///TODO: create mock of the following (user, organisation and userOrganisation) 
            var user = new User {UserId = 1, EmailAddress = "magnuski@hotmail.com", EmailVerifiedDate = VirtualDateTime.Now};
            var organisation = new Core.Entities.Organisation {OrganisationId = 0, SectorType = SectorTypes.Private};
            var userOrganisation = new UserOrganisation {
                OrganisationId = organisation.OrganisationId,
                Organisation = organisation,
                UserId = 1,
        ...
        public async Task SubmitController_EnterCalculations_POST_When_Return_Has_No_Values_Then_Show_All_Errors()
        {
            ...
            mockedDatabase
                .Setup(u => u.GetAll<Core.Entities.Organisation>())
        ...
        public async Task SubmitController_LateWarning_GET_When_Request_Is_String_Empty_Then_BadRequest_Is_Returned()
        {
            ...
            var testOrganisation = Mock.Of<Core.Entities.Organisation>(org => org.SectorType == SectorTypes.Public);
