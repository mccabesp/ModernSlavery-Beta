...
{
    [TestClass]
    public class ThreeDifferentRegistrationAttemptsFreezeUser : UITest
    {
        [TestMethod]
        public override void RunTest()
        {
            ...
            Set("Email").To("notregistered1@uat.co");
            ...
            Set("Email").To("notregistered2@uat.co");
            Set("Password").To("test");
            ...
            Set("Email").To("notregistered3@uat.co");
            Set("Password").To("test");
