...
{
    [TestFixture]
    public class CreateAccount_Admin : BaseUITest
    {
        public CreateAccount_Admin() : base(TestRunSetup.TestWebHost, TestRunSetup.WebDriverService)
        {
        ...
        public CreateAccount_Admin(string firstname, string lastname, string title, string email, string password) : base(TestRunSetup.TestWebHost, TestRunSetup.WebDriverService)
        {
