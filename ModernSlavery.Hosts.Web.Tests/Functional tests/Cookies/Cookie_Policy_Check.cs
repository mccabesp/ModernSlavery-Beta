    ...
    public class Cookie_Policy_Check : BaseUITest
    {
...

        {
            Try(
                    ...
                    () => { ExpectHeader("Cookies used by the Government Digital Service"); },
                    () => { BelowHeader("Cookies used by the Government Digital Service").Expect("The Government Digital Service use information about how you use the service to improve the experience across government digital services."); },
                    ...
                    () => { BelowHeader("Strictly necessary cookies").Expect("enable you to log in to submit information about your organisation's modern slavery statement"); },
...

        {
            ...
            ExpectHeader("Details about cookies on the Modern slavery statement registry");
            await Task.CompletedTask.ConfigureAwait(false);
        ...
        {
            Try(() => { Expect("The Modern slavery statement registry puts small files (known as ‘cookies’) onto your computer to collect information about how you browse the site. Find out more about the cookies we use, what they’re for and when they expire."); },
                     () => { ExpectHeader("Cookies that measure website usage"); },
                     () => { BelowHeader("Cookies that measure website usage").Expect("We use Google Analytics software (Universal Analytics) to collect anonymised information about how you use the service and GOV.UK. We do this to help make sure the site is meeting the needs of its users and to help us make improvements to the site and to government digital services."); },
                     ...
                     () => { ExpectHeader("Strictly necessary cookies"); },
                     () => { BelowHeader("Strictly necessary cookies").Expect("Logging in to the service"); },
                     () => { BelowHeader("Strictly necessary cookies").Expect("To add a modern slavery statement to the registry, you have to log in to the service. The following cookies are used as part of this log in process."); },
                     ...
                     () => { BelowHeader("Strictly necessary cookies").ExpectRowColumns(That.Contains, "idsrv", "Used during the log in process", "When you close your browser"); },
                     () => { BelowHeader("Strictly necessary cookies").ExpectRowColumns("idsrv", "Used during the log in process", "When you close your browser"); },
                     () => { BelowHeader("Strictly necessary cookies").ExpectRowColumns(".AspNetCore.Correlation.*", "Used during the log in process", "15 minutes"); },
                     () => { BelowHeader("Strictly necessary cookies").ExpectRowColumns(".AspNetCore.OpenIdConnect.*", "Used during the log in process", "15 minutes"); },
