...
namespace ModernSlavery.BusinessDomain.Shared.Models
{
    public class StatementsFileModel
    {
        ...
        public static StatementsFileModel Create(Statement statement, string statementSummaryUrl)
        {
            ...
            var result = new StatementsFileModel {
                ...
                StatementSummaryURL = statementSummaryUrl,
                ...
                ScopeStatus = statement.Organisation.GetActiveScopeStatus(statement.SubmissionDeadline)
        ...
        private static string JoinExcluding<T>(IEnumerable<T> source, params T[] exclude) where T : Enum
        {
