    ...
    public class StatementMapperProfile : Profile
    {
        public StatementMapperProfile()
        {
            ...
            CreateMap<Statement, StatementModel>()
                ...
                .ForMember(dest => dest.StatementTrainingDivisions, opt => opt.MapFrom(src => src.TrainingDivisions.Select(t => new KeyValuePair<int, string>(t.StatementDivisionTypeId, t.StatementTrainingType.Description))))
